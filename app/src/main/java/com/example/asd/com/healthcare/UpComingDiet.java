...
public class UpComingDiet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_up_coming_diet);
        ...
        dietList = dietInfo.getMemberUpcomingDietListByMemberId(memberId);
        ...
        ((TextView)findViewById(R.id.setTitile)).setText("Up Coming Diet");
