...
public class TodaysVaccine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_todays_vaccine);
        ...
        vaccineList = vaccineInfo.getMemberTodayVaccineListByMemberId(memberId);
        ...
        ((TextView)findViewById(R.id.setTitile)).setText("Today's Vaccine");
