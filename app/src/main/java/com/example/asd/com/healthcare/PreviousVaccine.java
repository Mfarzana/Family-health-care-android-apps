...
public class PreviousVaccine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vaccineList = vaccineInfo.getMemberPreviousVaccineListByMemberId(memberId);
        ...
        ((TextView)findViewById(R.id.setTitile)).setText("Previous Vaccine");
